...
const ChatPage = () => {
    ...
    // ENV VARIABLES
    const NAVBAR_HEADER = process.env.REACT_APP_COURSEVAL_HEADER;
                        ...
                        <div className="overlay" style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, .8)', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                            <div className="name-chat-popup">
                                ...
                                <div className="popup-body">
                                    ...
                                    <p>DISCLAIMER: Chat messages and Course Evaluations are not stored.</p>
                                </div>
                            </div>
                        </div>
                    )}
            ...
            <aside className="sidebar">
                ...
                {(!userInfo || !userInfo.email) && (
                    <div className="guest-login">
                        ...
                        </p>                        <button className="signup-button" >Sign up</button>
            ...
            <main style={{ flex: 1, overflowY: 'hidden', padding: '10px', display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div className='chatModal' >
                            ...
                            <div className="suggested-section">
                                ...
                                <div className="suggested-container" ref={suggestedContainerRef}>
                                    ...
                                    <div className="suggested-box">
                                        <p>Did students feel they received timely feedback on their assignments?</p>
                                        <small className='suggested-box-small'>I want to know if the instructional team was timely</small>
                                    </div>
                                    <div className="suggested-box">
                ...
                <div className="input-row">
                    <textarea
                        type="text"
                        id="question"
                        placeholder="Ask your Course Evaluation"
                    ...
                    />
                    <button type="submit" className="submit-chat" disabled={isLastMessageNew}>
